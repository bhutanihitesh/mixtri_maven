...
public class ChangePasswordService {
	...
	private String SENDER_EMAIL_ID="mixtri.live@gmail.com";
	//App Password Generated by google.
	private String PASSWORD="ddelgtjhjxwdnhpz";
	...
	public Response changePassword(@FormParam("emailId") String recipientEmail,@FormParam("emailToken") String emailToken,
		...
		if(userLoginBean.isUsernameAuthenticated()){
			...
			if(!validEmailToken){
				...
				return Response.status(Status.BAD_REQUEST).entity("Either the URL is incorrect or it has expired. Please request another URL.").build();
				
			}else{
				
				Profile profile = new Profile();
				serviceResponse=profile.changePassword(recipientEmail, newPassword, confirmPassword);
				mixtriDAO.deleteEmailPwdTokenDAO(emailToken);
