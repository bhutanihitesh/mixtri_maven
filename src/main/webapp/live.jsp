...
<link rel="stylesheet" type="text/css" media="screen" href="assets/css/messenger.css">
  ...
  <div id="logintab" class="mainbox modal-dialog col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
		...
		<div id="signuptab" class="mainbox modal-dialog col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
			<div class="panel panel-info">
				<div class="panel-heading">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<div class="panel-title">Time to rock your fans!
	...
	<div id="feedbackModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body feedbackModalClass">
					 <div id="divFeedback">
						<div>We take feedbacks very seriously. Your valuable feedback helps us improve the experience!</div>
						<form id="feeback" class="form-horizontal" role="form">
							<div class="form-group">
							    <div id="maxChars" style="color: graytext;font-size: small;">Chars Left 500</div>
  								<textarea id="feedbackText" class="form-control" rows="5" id="comment" style="width: 90%;" required></textarea>
							</div>
					...
					<div class="modal-footer">
					  <div id="btnsFeedback">
						<button id="btnCancelFeedback" type="button" class="btn btn-default commonButton" style="border-width: thin; border-color: #e62948" data-dismiss="modal">Return to homepage</button>
						<button id="btnSubmitFeedback" type="button" class="btn btn-default commonButton" style="border-width: thin; border-color: #e62948">Leave Feedback</button>
					 </div>
					 <div>
					 		<button id="btnReturnHome" type="button" class="btn btn-default commonButton hidden" style="border-width: thin; border-color: #e62948" data-dismiss="modal">Return to homepage</button>
					 </div> 	
					 </div>
		...
		<div id="endEvent" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
					  <div>
						<button id="btnYes" type="button" class="btn btn-default commonButton buttonSize" style="border-width: thin; border-color: #e62948"  data-dismiss="modal">Yes</button>
						<button id="btnNo" type="button" class="btn btn-default commonButton buttonSize" style="border-width: thin; border-color: #e62948" data-dismiss="modal">No</button>
					  </div> 	
					</div>
				</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-default eventModalButton" style="border-width: thin; border-color: #e62948"
		...
		<div class="row slidingGate">
			<div id="half1" class="col-xs-12 col-sm-12 col-md-6 cd-half-block1">
				<div class="clubMixtri eventEntry" style="margin-top: 150px;"><p>TIME TO GET IN THE MIX!</p></div>
			...
			<div id="half2" class="col-xs-12 col-sm-12 col-md-6 cd-half-block2">
				...
				<div class="enterClub">
					<div>
						<span style="color: graytext">Door Opens in: </span><span id="timeLeft"></span>
					</div>
					<button id="btnJoinEvent" class="btn btn-default commonButton"><span class="fa fa-sign-in"></span><span id="btnText">Join Event</span></button>
					<button id="btnStartEvent" class="btn btn-default commonButton"><span class="fa fa-sign-in"></span>Start Live Streaming</button>
				...
				<div class="text-center">
					<button id="btnIcecastSettings" type="button"
						...
						style="width: 400px;">View your icecast settings before streaming live!</button>
		...
		<div class="row eventInfoRow">
			...
			<div>
				...
				<!-- <h4>
				 ...
				 <br><div style="max-width: 250px; margin-bottom: 30px;">
						
						<a href="#" id="btnShowDjContactInfo"  style=" text-align: center; color: #e62948;  font-size:larger;"
							data-toggle="popover" title="Dj's Contact Info" 
							data-placement="top">
							Liked <span id="djName"></span>'s music? See contact Info for bookings!
						</a>						
				 </div>
				 
				 <div style="display: margin-bottom: 20px;">
					<button id="btnEndEvent" style="size: 100px;" data-toggle="modal" data-target="#endEvent" class="btn btn-default commonButton">End Event!</button>
					...
					<!-- <button id="btnIcecastSettings" type="button" class="btn btn-default commonButton btnIcecastSettings hidden"
					 ...
					 <a href="#" class="btnIcecastSettings hidden" style="color: #e62948; font-size:large;" data-toggle="modal" 
					 data-target="#modalIcecastSettings">View your icecast settings >></a>
			   ...
			   <div class="blink">
					<div>
						<span class="attendeeFanKudoCount"><i
							class="fa fa-user" style="color: #e62948"> Attendees</i> <span id="attendeeCount"> 0</span></span>
					</div>
					<div>
						<span class="attendeeFanKudoCount"><i
				...
				<div class="kudo-fan-attendee-count">
					<div>
							...
							<span style="margin-left: 20px;"><span id="wordFanUnfan">Fan</span>
							<i id="fan" class="fa fa-beer pointer-cursor" style="font-size: xx-large;"></i></span>
					</div>
